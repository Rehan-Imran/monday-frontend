...
const FolderItem = ({ title, children }) => {
  const [subfoldersList, setSubFldersList] = React.useState([]);
              ...
              <Flex>
                {isEdit ? (
                  <EditableText
                    ...
                    value={title || "New folder"}
                  />
                ) : (
                  <Text type={Text.types.TEXT2}>
                    {newTitle || title || "New folder"}
                  </Text>
                )}
              </Flex>
            </div>
            ...
            >
              <Menu id="menu" size="medium">
                ...
                <MenuItem
                  ...
                  iconType="SVG"
                  onClick={() => {
                    setSubFldersList([...subfoldersList, <SubFolder />]);
                  }}
                  title="New subfolder"
                />
